...
for DIST in `cat dists/$ARCH`; do
    ...
    docker build --pull --build-arg BASE=${STABLE_TAG} -f docker/Dockerfile-latest-debian -t 768356633999.dkr.ecr.eu-central-1.amazonaws.com/package-builder:${LATEST_TAG} .
