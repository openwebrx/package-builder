...
for DIST in ${params.dists.join(" ")}; do
    ...
    rm packages.tar.gz
        ...
        s3Upload acl: 'Private', bucket: 'de.dd5jfk.openwebrx.debian-packages', cacheControl: '', excludePathPattern: '', includePathPattern: '**/*.deb,**/*.ddeb',  metadatas: [''], path: params.releaseBranch ? 'release/' : 'experimental/', redirectLocation: '', sseAlgorithm: '', workingDir: 'output'
